...
var (
	tenantAllColumns            = []string{"id", "status", "name", "created_at", "updated_at", "view_params", "crm_id", "is_test_instance", "parent_tenant_id", "group_sync_state", "group_sync_metadata", "permissions", "prelaunch_state"}
	tenantColumnsWithoutDefault = []string{"id", "status", "name", "view_params", "parent_tenant_id"}
	tenantColumnsWithDefault    = []string{"created_at", "updated_at", "crm_id", "is_test_instance", "group_sync_state", "group_sync_metadata", "permissions", "prelaunch_state"}
