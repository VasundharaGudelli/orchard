...
var (
	...
	groupColumnsWithoutDefault = []string{"id", "tenant_id", "name", "group_path"}
	groupColumnsWithDefault    = []string{"type", "status", "role_ids", "crm_role_ids", "parent_id", "order", "created_by", "created_at", "updated_by", "updated_at", "sync_filter", "opportunity_filter"}
...
func (o *Group) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return GroupExists(ctx, exec, o.TenantID, o.ID)
}
