...
func CRMRoles(mods ...qm.QueryMod) crmRoleQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"crm_role\".*"})
	}

	return crmRoleQuery{q}
}
...
// Exists checks if the CRMRole row exists.
func (o *CRMRole) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return CRMRoleExists(ctx, exec, o.TenantID, o.ID)
}
