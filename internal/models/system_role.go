...
var (
	...
	systemRoleColumnsWithoutDefault = []string{"id", "name"}
	systemRoleColumnsWithDefault    = []string{"tenant_id", "description", "type", "status", "priority", "created_by", "created_at", "updated_by", "updated_at", "permissions", "base_role_id"}
