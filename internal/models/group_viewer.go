...
var (
	...
	groupViewerGeneratedColumns      = []string{}
)
...
func GroupViewers(mods ...qm.QueryMod) groupViewerQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"group_viewer\".*"})
	}

	return groupViewerQuery{q}
}
...
// Exists checks if the GroupViewer row exists.
func (o *GroupViewer) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return GroupViewerExists(ctx, exec, o.TenantID, o.PersonID, o.GroupID)
}
