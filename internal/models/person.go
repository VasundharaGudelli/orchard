...
type Person struct {
	...
	OutreachProfileID   null.String       `boil:"outreach_profile_id" json:"outreach_profile_id,omitempty" toml:"outreach_profile_id" yaml:"outreach_profile_id,omitempty"`
	OutreachProfileName null.String       `boil:"outreach_profile_name" json:"outreach_profile_name,omitempty" toml:"outreach_profile_name" yaml:"outreach_profile_name,omitempty"`
...
var PersonColumns = struct {
	...
	OutreachProfileID:   "outreach_profile_id",
	OutreachProfileName: "outreach_profile_name",
}
...
var PersonTableColumns = struct {
	...
	OutreachProfileID:   "person.outreach_profile_id",
	OutreachProfileName: "person.outreach_profile_name",
}
...
var PersonWhere = struct {
	...
	OutreachProfileID   whereHelpernull_String
	OutreachProfileName whereHelpernull_String
}{
	...
	OutreachProfileID:   whereHelpernull_String{field: "\"person\".\"outreach_profile_id\""},
	OutreachProfileName: whereHelpernull_String{field: "\"person\".\"outreach_profile_name\""},
}
...
var (
	personAllColumns            = []string{"id", "tenant_id", "name", "first_name", "last_name", "email", "manager_id", "role_ids", "crm_role_ids", "is_provisioned", "is_synced", "status", "created_by", "created_at", "updated_by", "updated_at", "group_id", "type", "photo_url", "outreach_id", "outreach_is_admin", "outreach_guid", "outreach_profile_id", "outreach_profile_name"}
	personColumnsWithoutDefault = []string{"id", "tenant_id"}
	personColumnsWithDefault    = []string{"name", "first_name", "last_name", "email", "manager_id", "role_ids", "crm_role_ids", "is_provisioned", "is_synced", "status", "created_by", "created_at", "updated_by", "updated_at", "group_id", "type", "photo_url", "outreach_id", "outreach_is_admin", "outreach_guid", "outreach_profile_id", "outreach_profile_name"}
